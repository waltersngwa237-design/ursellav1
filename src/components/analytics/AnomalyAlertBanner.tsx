    ...
    <div className="space-y-2.5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {anomalies.map((a) => {
          ...
          let icon = <AlertCircle className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />;
            ...
            >
              ...
              <div className="space-y-1 text-xs">
                <div className="flex items-center justify-between gap-2">
                  ...
                  {a.metricValue && (
                    <span className="text-[11px] font-mono px-1.5 py-0.2 rounded bg-black/40 text-zinc-200">
                      {a.metricValue}
                    </span>
                  )}
                </div>
