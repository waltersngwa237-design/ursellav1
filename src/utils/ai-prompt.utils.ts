/**
 * Utility functions for AI prompt formatting and follow-up suggestion normalization.
 */

/**
 * Sanitizes follow-up suggestions so they are always phrased from
 * the perspective of the merchant requesting what they need next
 * from Ursella AI, rather than the AI asking if the merchant wants something.
 */
...
/**
 * Sanitizes a list of suggestions into natural, user-perspective questions/requests.
 */
