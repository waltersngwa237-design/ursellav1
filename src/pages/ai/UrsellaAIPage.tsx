        ...
        >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <button
              ...
              className={`flex items-center gap-1.5 px-2 sm:px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer border ${
                isDark
            ...
            <div className="relative" ref={optionsMenuRef}>
              ...
              {showOptionsMenu && (
                <div className={`absolute right-0 top-full mt-2 w-52 rounded-xl backdrop-blur-md border py-1.5 shadow-2xl z-50 animate-in fade-in-50 zoom-in-95 ${
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <span>{isFr ? "Mémoire d'Ursa" : "Ursa Memory Bank"}</span>
                    </div>
                    {memoryCount > 0 && (
          ...
          {messages.length === 0 && (
            <div className="max-w-2xl mx-auto py-4 sm:py-10 space-y-5">
              <div className="text-center space-y-1.5 px-2">
                ...
                {/* Memory Bank Quick Access Badge */}
                <div className="pt-2">
                  <button
                    type="button"
                    onClick={() => setIsMemoryModalOpen(true)}
                  ...
                  >
                    ...
                    <span>
                      {isFr
                        ? `Mémoire d'Ursa (${memoryCount} faits enregistrés)`
                        : `Ursa Memory Bank (${memoryCount} facts stored)`}
                    </span>
                  </button>
                </div>
              </div>
